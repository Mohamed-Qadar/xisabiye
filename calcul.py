...
b = []
for i in range(1,10):
    b.append(Button(text=str(i),font="verdana 14 bold",fg="BLUE",command=lambda x=i: yaz(x)))
...
for i in range(0,4):
    islem.append(Button(font="Verdana 14 bold",fg ="GREEN",width=2,command=lambda x=i:islemler(x)))
...
sb =Button(text=0,fg="blue",font="verdana 14 bold",command=lambda x=0: yaz(x))
sb.place(x=20,y=200)
nb =Button(text=".",fg="blue",font="verdana 14 bold",command=lambda x=".": yaz(x))
nb.place(x=70,y=200)
